                            ...
                            <div class="ibox float-e-margins">
                                ...
                                <div class="ibox-content">
                                    <ul class="todo-list m-t small-list">
                                        <li>
                                            <a href="dashboard_2.html#" class="check-link"><i class="fa fa-check-square"></i> </a>
                                            <span class="m-l-xs todo-completed">Buy a milk</span>

                                        </li>
                                        <li>
                                            <a href="dashboard_2.html#" class="check-link"><i class="fa fa-square-o"></i> </a>
    ...
    <div id="right-sidebar">
        <div class="sidebar-container">
            ...
            <ul class="nav nav-tabs navs-3">
                ...
                <li class="active"><a data-toggle="tab" href="dashboard_2.html#tab-1">
                    Notes
                </a></li>
                <li><a data-toggle="tab" href="dashboard_2.html#tab-2">
                    Projects
                </a></li>
                <li class=""><a data-toggle="tab" href="dashboard_2.html#tab-3">
...
<script src="${ctx}/static/inspinia_admin/js/plugins/flot/jquery.flot.time.js"></script>
...
<!-- EayPIE -->
<script src="${ctx}/static/inspinia_admin/js/plugins/easypiechart/jquery.easypiechart.js"></script>
