...
<head>
    ...
    <!-- Morris -->
    <link href="${ctx}/static/inspinia_admin/css/plugins/morris/morris-0.4.3.min.css" rel="stylesheet">
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            ...
                            <div class="ibox-tools">
                                ...
                                <a class="dropdown-toggle" data-toggle="dropdown" href="dashboard_4_1.html#">
                                    <i class="fa fa-wrench"></i>
                                </a>
                                <ul class="dropdown-menu dropdown-user">
                                    <li><a href="dashboard_4_1.html#">Config option 1</a>
                                    </li>
                                    <li><a href="dashboard_4_1.html#">Config option 2</a>
                                    </li>
                                </ul>
                                <a class="close-link">
    ...
    <div id="right-sidebar">
        <div class="sidebar-container">
            ...
            <ul class="nav nav-tabs navs-3">
                ...
                <li class="active"><a data-toggle="tab" href="dashboard_4_1.html#tab-1">
                    Notes
                </a></li>
                <li><a data-toggle="tab" href="dashboard_4_1.html#tab-2">
                    Projects
                </a></li>
                <li class=""><a data-toggle="tab" href="dashboard_4_1.html#tab-3">
