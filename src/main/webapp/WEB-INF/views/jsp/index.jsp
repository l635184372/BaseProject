...
<div id="wrapper">
            ...
            <ul class="nav metismenu" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element"> <span>
                            <img alt="image" class="img-circle" src="${ctx}/static/inspinia_admin/img/profile_small.jpg" />
                             </span>
                ...
                <li class="active">
                    <a href="index.jsp"><i class="fa fa-th-large"></i> <span class="nav-label">仪表板列表</span> <span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li class="active"><a href="${sysPage}/dashboard_1" target="mainFrame">仪表板 v.1</a></li>
                        <li><a href="${sysPage}/dashboard_2" target="mainFrame">仪表板 v.2</a></li>
                        <li><a href="${sysPage}/dashboard_3" target="mainFrame">仪表板 v.3</a></li>
                        <li><a href="${sysPage}/dashboard_4" target="mainFrame">仪表板 v.4</a></li>
                        <li><a href="${sysPage}/dashboard_5" target="mainFrame">仪表板 v.5 <span class="label label-primary pull-right">NEW</span></a></li>
                    </ul>
                </li>
                <li>
                    <a href="${sysPage}/layouts" target="mainFrame"><i class="fa fa-diamond"></i> <span class="nav-label">布局样式</span></a>
                </li>
                <li>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level collapse">
                        ...
                        <li><a href="mail_detail.html">浏览邮件</a></li>
    ...
    <div class="row border-bottom">
                        ...
                        <li>
                            <div class="dropdown-messages-box">
                                <a href="profile.html" class="pull-left">
                                    <img alt="image" class="img-circle" src="${ctx}/static/inspinia_admin/img/a7.jpg">
                                </a>
        ...
        <div id="right" style="margin-left: 0px;">
            <iframe id="mainFrame" name="mainFrame" src="" style="overflow:hidden;" frameborder="no" width="100%" height="85%"></iframe>
        </div>
    </div>
    <%--<div id="page-wrapper" class="gray-bg dashbard-1">--%>
        <%--<div class="row border-bottom">--%>
                    ...
                    <%--<li class="dropdown">--%>
                        ...
                        <%--<ul class="dropdown-menu dropdown-messages">--%>
                            ...
                            <%--<li>--%>
                                <%--<div class="dropdown-messages-box">--%>
                                    <%--<a href="profile.html" class="pull-left">--%>
                                        <%--<img alt="image" class="img-circle" src="${ctx}/static/inspinia_admin/img/profile.jpg">--%>
                                    <%--</a>--%>
                                    <%--<div class="media-body ">--%>
                                        <%--<small class="pull-right">23h ago</small>--%>
                                        <%--<strong>Monica Smith</strong> love <strong>Kim Smith</strong>. <br>--%>
                                ...
                                <%--<div class="ibox-content">--%>
                                    ...
                                    <%--<div>--%>
                                        <%--<div class="feed-activity-list">--%>
                                            ...
                                            <%--<div class="feed-element">--%>
                                                <%--<a href="profile.html" class="pull-left">--%>
                                                    <%--<img alt="image" class="img-circle" src="${ctx}/static/inspinia_admin/img/a5.jpg">--%>
                                                <%--</a>--%>
                                                <%--<div class="media-body ">--%>
                                                    <%--<small class="pull-right">2h ago</small>--%>
